...
def gera_dados_exemplo(num_registros):
    ...
    nomes = ["Alice", "Bob", "Carol", "John", "Eve", "Frank", "Grace", "Hank", "Ivy", "Jack", "Marcelo", "Arthur", "Ethan", "Jully"]
    cidades = ["Natal", "Rio de Janeiro", "Blumenau", "Salvador", "Palmas", "Curitiba", "Fortaleza", "Manaus", "Recife", "Porto Alegre", "Sao Paulo", "Florianopolis"]
